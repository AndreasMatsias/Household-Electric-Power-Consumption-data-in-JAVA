...
public class mainEngineTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		inputFilename = "C:\\Users\\andre\\Desktop\\ECLIPSE_WORKSPACE\\P_VAS_PROJECT_2019-2020\\Resources\\TestInput\\2007_sample.tsv";
		delimeter = "\t";
		hasHeader = false;
		numFields = 9;
		objCollection = new ArrayList<MeasurementRecord>(); 
	...
	public final void testReportResultInFile() {
		outputFilename = "C:\\Users\\andre\\Desktop\\ECLIPSE_WORKSPACE\\P_VAS_PROJECT_2019-2020\\Resources\\TestInput\\2007_sample11.md";
		int numRows = mainEngine.loadData(inputFilename, delimeter, hasHeader, numFields, objCollection);
		//System.out.println("Size to process: " + numRows);
		...
		assertEquals(FileUtilities.countLinesOfAFile(outputFilename),117);
