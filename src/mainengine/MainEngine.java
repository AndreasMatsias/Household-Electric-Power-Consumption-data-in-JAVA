...
public class MainEngine implements IMainEngine
{
			...
			ArrayList<MeasurementRecord> objCollection)
	{
		...
		return loader.load(fileName,delimeter,hasHeaderLine,numFields,data);
			...
			String aggFunction, String description) 
	{
		...
		IAggregator aggregator = aggregatorFactory.createAggregator(aggregatorType);
		return aggregator.aggregateByTimeUnit(data,aggFunction,description);
	}
	/**
	...
	private ArrayList<MeasurementRecord> data;
}
